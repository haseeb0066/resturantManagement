...
import com.godeliver.user.Activity.LogInActivity;

import java.util.HashMap;

import static com.godeliver.user.Config.BaseURL.IS_LOGIN;
import static com.godeliver.user.Config.BaseURL.KEY_ID;
import static com.godeliver.user.Config.BaseURL.KEY_NAME;
import static com.godeliver.user.Config.BaseURL.KEY_PASSWORD;
import static com.godeliver.user.Config.BaseURL.PREFS_NAME;
import static com.godeliver.user.Config.BaseURL.PREFS_NAME2;
import static com.godeliver.user.Config.BaseURL.USER_CURRENCY;
import static com.godeliver.user.Config.BaseURL.USER_CURRENCY_CNTRY;
